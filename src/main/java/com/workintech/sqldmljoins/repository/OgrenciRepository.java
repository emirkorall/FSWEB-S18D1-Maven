...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif,COUNT(i.kitapno) AS okunankitap FROM ogrenci o LEFT JOIN islem i ON o.ogrno=i.ogrno WHERE o.sinif IN ('10A','10B') GROUP BY o.sinif";

    @Query(value = QUESTION_4, nativeQuery = true)
    List<KitapCount> findClassesWithBookCount();

    //Öğrenci tablosundaki öğrenci sayısını gösterin
    String QUESTION_5 = "SELECT COUNT(*) as ogrencisayısı FROM ogrenci";
    ...
    //--Ali: 2, Mehmet: 3
    String QUESTION_7 = "SELECT ad,COUNT(*) ogrencisayısı FROM ogrenci GROUP BY ad";
